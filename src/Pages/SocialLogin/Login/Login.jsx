    ...
    return (
        ...
        <section className="bg-white dark:bg-gray-900">
          <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
            <div className="w-full max-w-md border dark:border-slate-800 p-6 shadow-sm">
            <form
            ...
            >
              ...
              <div className="mt-6">
                <button
                  type="submit"
                  className="w-full bg-accent rounded-lg py-2 px-6 text-white focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50"
                >
                  {/* {loading ? <SmallSpinner></SmallSpinner> : "Log In"} */}Log In
                </button>
              </div>
            </form>
